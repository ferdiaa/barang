<?php namespace App\Http\Controllers;
	...
	class AdminBarangController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Deskrpsi","name"=>"deskrpsi"];
			...
			$this->form[] = ['label'=>'Deskrpsi','name'=>'deskrpsi','type'=>'textarea','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Deskrpsi","name"=>"deskrpsi","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
